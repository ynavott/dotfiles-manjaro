# Generated by Powerlevel10k configuration wizard on 2020-08-27 at 23:25 IDT.
# Based on romkatv/powerlevel10k/config/p10k-lean-8colors.zsh, checksum 24162.
# Wizard options: nerdfont-complete + powerline, small icons, unicode, lean_8colors,
# 24h time, 2 lines, dotted, right frame, white-ornaments, sparse, many icons, concise,
...
() {
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_PRECISION=0.01
